...
<head>
    ...
    <title>Studylogin project</title>
...
<body>
    ...
    <div class="container is-fluid">
        <div class="section">
        <h1 class="title is-3">What is Lorem Ipsum?</h1>
                <p class="">
    ...
    <div class="container is-fluid">
        <div class="section">
        <h1 class="title is-3">Why do we use it?</h1>
                <p class="">
    ...
    <div class="container is-fluid">
        <div class="section">
        <h1 class="title is-3">Where does it come from?</h1>
                <p class="">
